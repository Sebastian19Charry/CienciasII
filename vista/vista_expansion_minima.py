from PySide6.QtWidgets import (
    ...
    QPushButton, QFrame, QSpinBox, QFileDialog, QScrollArea, QTextEdit, QTabWidget, QComboBox, QSplitter
)
...
class VistaExpansionMinima(QWidget):
    def __init__(self, main_window, parent_nav):
        super().__init__()
        self.main_window = main_window
        self.parent_nav = parent_nav
        self.controller = MinimaController(self)
        ...
        titulo = QLabel("Árbol de Expansión Mínima")
        ...
        self.visual_arbol = VisualizadorGrafo("A.E.M.", self, es_editable=False)
